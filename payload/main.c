...
int ef2IdStorageLeafVerify68(Ef2IdStorageLeafData *pArg){
...
int ef2IdStorageLeafResign68(Ef2IdStorageLeafData *pArg){
...
int ef2IdStorageLeafVerify70(Ef2IdStorageLeafData2 *pArg){
...
int ef2IdStorageLeafResign70(Ef2IdStorageLeafData2 *pArg){
 ...
 */
int ef2Hello(Ef2HelloParam *pArg){
...
int ef2F00dTempCexSpoof(void *pArg){
...
int handler(SceSblSmschedProxyArg *proxy_arg, int cmd, void *arg){
	...
	switch(cmd){
	case EF2_CMD_IDSTORAGE_LEAF_VERIFY_68:
		res = ef2IdStorageLeafVerify68((Ef2IdStorageLeafData *)arg);
		break;

	case EF2_CMD_IDSTORAGE_LEAF_RESIGN_68:
		res = ef2IdStorageLeafResign68((Ef2IdStorageLeafData *)arg);
		break;

	case EF2_CMD_IDSTORAGE_LEAF_VERIFY_70:
		res = ef2IdStorageLeafVerify70((Ef2IdStorageLeafData2 *)arg);
		break;

	case EF2_CMD_IDSTORAGE_LEAF_RESIGN_70:
		res = ef2IdStorageLeafResign70((Ef2IdStorageLeafData2 *)arg);
		break;

	case EF2_CMD_F00D_TEMP_CEX_SPOOF:
		res = ef2F00dTempCexSpoof(arg);
		break;

	case EF2_CMD_HELLO:
		res = ef2Hello((Ef2HelloParam *)arg);
		break;

	case EF2_CMD_RESERVED:
