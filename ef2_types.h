/*
 * Execute Framework in F00D header
 * Copyright (C) 2020, Princess of Sleeping
 */

#ifndef _EF2_TYPES_H_
#define _EF2_TYPES_H_

#define EF2_CMD_IDSTORAGE_LEAF_VERIFY_68	(3)
#define EF2_CMD_IDSTORAGE_LEAF_RESIGN_68	(4)
#define EF2_CMD_IDSTORAGE_LEAF_VERIFY_70	(8)
#define EF2_CMD_IDSTORAGE_LEAF_RESIGN_70	(9)
#define EF2_CMD_F00D_TEMP_CEX_SPOOF		(0x10)
#define EF2_CMD_HELLO				(0x10001)
#define EF2_CMD_RESERVED			(0x10000)
...
typedef struct Ef2HelloParam {
	unsigned int auth_word[4];
} Ef2HelloParam;

typedef struct Ef2IdStorageLeafData {
	char data[0x200];
	char hash[0x20];
} Ef2IdStorageLeafData;

typedef struct Ef2IdStorageLeafData2 {
	char data[0x200];
	char data2[0x200];
	char hash[0x20];
} Ef2IdStorageLeafData2;
